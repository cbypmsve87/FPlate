...
<title>深圳万平科技有限公司－官网首页</title>
<meta name="keywords"
	content="深圳万平,万平科技,万平软件开发,万平APP开发,万平微信公众号开发,万平系统集成,万平科技有限公司">
...
<body data-spy="scroll" data-target="#navbar" data-offset="0">
	...
	<!--/#header-->
				...
				<div class="item active">
					<div class="container">
						<div class="carousel-content">
							...
							<div class="pic">
								<img src="images/ppt3.jpg"
									alt="深圳万平科技有限公司－认真做事，小而美！ Small and beautiful!" />
							</div>
				...
				<div class="item">
					<div class="container">
						<div class="carousel-content">
							...
							<div class="pic">
								<img src="images/ppt1.jpg" alt="深圳万平科技有限公司－立足新起点，开创新局面。" />
							</div>
						</div>
					</div>
				</div>
		    ...
		    <i class="glyphicon glyphicon-menu-left"></i></a>
			<a class="next" href="#main-slider" data-slide="next">
			<i class="glyphicon glyphicon-menu-right"></i></a> </section>
			<!--/#main-slider-->
					...
					<div class="row">
						<div class="col-md-2dot4 col-sm-6">
							<div class="center">
								...
								<h4>系统集成</h4>
								<p>
									低成本的、高效率的<br> 性能匀称的<br> 可扩充性、可维护
								</p>
							</div>
						</div>
						<!--/.col-md-2dot4-->
						<div class="col-md-2dot4 col-sm-6">
							<div class="center">
								...
								<h4>APP应用开发</h4>
								<p>
									iOS、Andriod<br> 抢占商机、清新美观<br> 体验感强、成本低廉
								</p>
							</div>
						</div>
						<!--/.col-md-2dot4-->
						<div class="col-md-2dot4 col-sm-6">
							<div class="center">
								...
								<h4>网站开发</h4>
								<p>
									HTML5+CSS3+JAVA(PHP)<br> 美观大方，完美体验<br> 安全性能高
								</p>
							</div>
						</div>
						<!--/.col-md-2dot4-->
						<div class="col-md-2dot4 col-sm-6">
							<div class="center">
								...
								<h4>企业应用</h4>
								<p>
									功能全面，界面美观<br> 安全性能高<br> 无缝对接的后期维护
								</p>
							</div>
						</div>
						<!--/.col-md-2dot4-->
						<div class="col-md-2dot4 col-sm-6">
							<div class="center">
								...
								<h4>CRM</h4>
								<p>
									客户资源、客户关系<br> 客户数据<br> 客户关怀等管理维护
								</p>
							</div>
						</div>
						<!--/.col-md-2dot4-->
			...
			<div class="container">
				<div class="box">
					...
					<div class="box_title">
						...
						<span></span>
						<div class="content">
							以客户需求为导向，以客户价值为目标，以客户满意为标准<br> 坚持变革，倡导创新，持续成长。
							快速反应，快速决策，快速行动<br> 企业与员工共同成长， 专注主营业务。
						</div>
					</div>
					<!--/.center-->
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12" style="font-size: 16px;">
						Copyright &copy; 2017 wanping Technology Inc. 保留所有权利。&nbsp;&nbsp;
						<script>
						/* var _hmt = _hmt || [];
						(function() {
