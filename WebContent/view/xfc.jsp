...
<meta name="keywords" content="成都小风车,小风车科技,成都软件开发,成都APP开发,成都微信公众号开发,成都系统集成,成都小风车科技有限公司">
<meta name="description" content="成都小风车科技有限公司简称小风车，是一家集工商、法院、教育等行业软件研发和软件外包、大数据、金融服务业务、IT技术培训等业务的科技企业。">
        ...
        <div class="item active">
            <div class="container">
                <div class="carousel-content">
                	...
                	<div class="title">
                        <h1>认真做事，小而美！ Small and beautiful!</h1>
                        <p class="lead"></p>
                    </div>
                    <div class="pic"><img src="images/ppt3.jpg" alt="成都小风车科技有限公司－认真做事，小而美！ Small and beautiful!"/></div>
           ...
           <div class="box_title">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <div class="item-inner">
                        <div class="portfolio-image">
                          <img src="images/product_app1.png">
                          <div class="overlay">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <div class="item-inner">
                        <div class="portfolio-image">
                          <img src="images/product_com4.jpg">
                          <div class="overlay">
                              <a class="preview" title="" href="javascript:;"></a>             
                          </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="center client_box">
                        <a href="javascript:;"><i class="icon-client" style="background:url(images/client2.png) no-repeat center"></i></a>
                    </div>
                </div><!--/.col-md-3-->
                <div class="col-md-3 col-sm-6">
                    <div class="center client_box">
                        <a href="javascript:;"><i class="icon-client" style="background:url(images/client7.png) no-repeat center"></i></a>
                    </div>
                </div><!--/.col-md-3-->
                <div class="col-md-3 col-sm-6">
                    <div class="center client_box">
                        <a href="javascript:;"><i class="icon-client" style="background:url(images/client6.png) no-repeat center"></i></a>
                    </div>
                </div><!--/.col-md-3--><div class="col-md-3 col-sm-6">
                    <div class="center client_box">
                        <a href="javascript:;"><i class="icon-client" style="background:url(images/client5.png) no-repeat center"></i></a>
                    </div>
                </div><!--/.col-md-3-->
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12" style="font-size:16px;">
            	Copyright &copy; 2017 Xiaofengche Inc. 保留所有权利。&nbsp;&nbsp;
<script>
var _hmt = _hmt || [];
(function() {
    ...
    <div class="side_list">
      ...
      <div class="side_center">
        <div class="custom_service">
          <p> <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=459104018&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:459104018:41" alt="点击这里给我发消息" title="点击这里给我发消息"></a> </p>
        </div>
        <div class="other">
          <p>
          合作洽谈QQ：<br/>
          459104018<br/>
          合作洽谈微信：<br/>
          <img src="images/qrcode.png" width="100" style="margin-top: 5px;"/></p>
          <p>客户服务热线<br/>028-67871837<br/>13568933413</p>
        </div>
      </div>
